...
public class View extends JFrame implements ActionListener {
    ...
    public void initEditor() {
        ...
        JScrollPane spHTML = new JScrollPane(htmlTextPane);
        tabbedPane.addTab("HTML", spHTML);

        JScrollPane spPLAIN = new JScrollPane(plainTextPane);
        tabbedPane.addTab("Текст", spPLAIN);
    ...
    public void showAbout(){
        JOptionPane.showMessageDialog(this, "HTML Editor Info: created by Pavel Kalesnikau", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
}
